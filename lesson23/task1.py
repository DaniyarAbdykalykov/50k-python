...
print('сортировка по возрасту:', sorted(students, key=lambda x: x['age']), end='\n\n')
print("сортировка по курсу:", sorted(students, key=lambda x: x['course']), end='\n\n')
print("сортировка по имени:", sorted(students, key=lambda x: x['name']))